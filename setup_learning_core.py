...
cognitive_engine_code = '''# -*- coding: utf-8 -*-
import time
import json
import threading
...
with open("backend/cognitive_brain.py", "w", encoding="utf-8") as f:
    f.write(cognitive_engine_code)

print("[SUCCESS] Autonomous Cognitive Brain Module Integrated!")